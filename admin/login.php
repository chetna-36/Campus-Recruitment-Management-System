...
<head>
    ...
    <title>Resume Management System-Login Page</title>
    <!-- CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>Welcome Back</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Hey Buddies Welcome back to Resume Management System AdminPanel !</p>
                    </div>
